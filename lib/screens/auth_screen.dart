...
class _AuthScreenState extends State<AuthScreen> {
  ...
  TextFormField _textFormField({
    ...
    return TextFormField(
      ...
      keyboardType: textFormType == TextFormType.email ? TextInputType.text : TextInputType.emailAddress,
      onSaved: (value) => {
        if (textFormType == TextFormType.email) _authData['email'] = value ?? '' else if (textFormType == TextFormType.password) _authData['password'] = value ?? ''
      },
      validator: (value) {
        ...
        if (textFormType == TextFormType.email) {
          ...
          if (_screenMode == ScreenMode.signUp && finalValue != _passwordController.text) {
      ...
      decoration: InputDecoration(
        prefixIcon: textFormType == TextFormType.email ? const Icon(Icons.mail) : const Icon(Icons.lock),
